...
$sql = "SELECT p.Id, p.Nombre, p.Descripcion, 
            ...
            p.PaginaCategorias, p.AgregarCategoria, p.EditarCategoria, p.AnularActivarCategoria,
            p.PaginaUsuario, p.CrearUsuario, p.ActivarDesactivarUsuario, p.CrearRol, p.ActivarDesactivarRol
        FROM perfiles p";
